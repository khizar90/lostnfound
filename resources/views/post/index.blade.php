                                ...
                                <div class="card border-0" style="width: 19.5rem;">
                                    <div class="loadercenter">
                                        ...
                                        <img src="{{ $post->image }}" class="card-img-top object-fit-cover  "
                                            alt="Your Image" id="image" height="200px" width="100%" style="object-fit: cover">
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                        ...
                                        <div class="card-text ellipsis text-body mb-2" id="cardPara">{{ $post->description ?: 'No Description' }}</div>
                                        
                                        <h5 class="card-title mb-0">Type:</h5>

                                        <div class="card-text ellipsis text-body mb-2" id="cardPara">{{ $post->type }}</div>
                                        ...
                                        <div class="card-text ellipsis text-body mb-2" id="cardPara">{{ $post->created_at }}</div>
